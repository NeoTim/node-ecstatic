...
var ecstatic = module.exports

// This is the middleware.
ecstatic = equip.configurable(function configurable (options) {
  ...
  // Custom attachment behavior.
  // Eventually going to handle pushing options to an "oilpan".
  ecstatic.attach = function (opts) {
    var app = this;

    app.http.before.push(ecstatic(opts));
  }

  ecstatic.init = function (done) {
    done();
  }
